...
class Navbar extends React.Component {
    ...
    render() {
        ...
        let modalContentDiv = document.getElementById(this.state.modalContent)
        ...
        return (
            <div>
                <div className={"modal" + (this.state.modalContent !== "none" ? " is-active" : "")}>
                    <Modal onClose={() => this.setState({modalContent: "none"})}>
                        <div id="peopleContent" className="modal-content">
                    ...
                    <div className={isActive + "navbar-menu"}>
                        <div className="navbar-end">
                            <a
                                ...
                                href="#"
                                onClick={() => this.setState({ modalContent: "peopleContent" })}
                            >
                                People
                            </a>
