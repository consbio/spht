...
const Advanced = ({ colorScheme, onSelectScheme }) => <div>
    <h4 className="title is-5">Color Scheme</h4>
    {colors.map((scheme, i) => <div style={{marginBottom: '20px'}} key={'' + i}>
        <div className="is-inline-block" style={{verticalAlign: 'middle', marginRight: '10px'}}>
            <input type="radio" checked={i === colorScheme} onChange={() => onSelectScheme(i)}></input>
        </div>
